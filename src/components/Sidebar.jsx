...
import { AiOutlineClose, AiOutlineFileAdd, AiOutlineHome, AiOutlineNotification, AiOutlineSetting } from "react-icons/ai"
...
const Sidebar = () => {
    return (
        <div className="bg-base-300 h-screen relative px-2 py-2 ">
            <div className="mt-2 ml-2 ">
                ...
                <AiOutlineClose className="absolute top-2 cursor-pointer p-1 right-2 lg:hidden" size={30} />
            </div>

            <div className="mt-8 list-none space-y-5 ">
                <NavLink to="/" className="flex p-1 px-6 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                        <AiOutlineHome />
                        <li>Home</li>
                    </div>
                ...
                <NavLink to="/dashboard" className="flex px-6 py-1 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                ...
                <NavLink to="/notifications" className="flex px-6 py-1 items-center justify-between gap-5 ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                ...
                <NavLink to="/services" className="flex px-6 py-1 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                ...
                <NavLink to="/add-services" className="flex px-6 py-1 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                        <AiOutlineFileAdd />
                        <li>Add Services</li>
                    </div>
                ...
                <NavLink to="/users" className="flex px-6 py-1 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                        <FiUsers />
                        <li>Users</li>
                    </div>
                ...
                <NavLink to="/logout" className="flex px-6 py-1 items-center justify-between ">
                    <div className="flex items-center gap-2 text-md font-semibold text-red-300">
                        <BiLogOut />
                        <li>Logout</li>
                    </div>
                    <div className="text-blue-300 text-md mt-1  text-center">
                ...
                <div className="absolute bottom-10 space-y-4">
                    <NavLink to="/help" className="flex px-6 py-1 items-center justify-between ">
                        <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                            <BiHelpCircle />
                            <li>Help</li>
                        </div>
                    ...
                    <NavLink to="/settings" className="flex px-6 py-1 items-center justify-between ">
                        <div className="flex items-center gap-2 text-md font-semibold text-blue-400">
                            <AiOutlineSetting />
                            <li>Settings</li>
                        </div>
